...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchResults = (function () {
	        ...
	        this.searchResultsService.getAll(this.searchTerm)
	            ...
	            _this.products = result.map(function (x) {
	                ...
	                x.scrapeResults = x.scrapeResults.map(function (y) {
	                    y.websiteName = _this.getWebsiteName(y.website);
	                    return y;
	                });
	                return x;
	            });
	    ...
	    SearchResults.prototype.getWebsiteName = function (website) {
	        switch (website) {
	...
	var ProductScrape = (function () {
	    function ProductScrape(rating, website, url, websiteName) {
	        this.rating = rating;
